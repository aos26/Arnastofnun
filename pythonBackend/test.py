...
words = pd.read_csv(r'C:\Users\alext\CodeStuff\GitHub\Arnastofnun\pythonBackend\gogn.csv', sep=';', error_bad_lines=False, encoding='ISO 8859-15')
...
#print(response.json())
for i in range(9000):#range(len(words)):
